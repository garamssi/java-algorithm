package garam.week3.tuesday_그래프.문제2_courseSchedule;
...
public class Solution {
	...
	public static boolean canFinish(int numCourses, int[][] prerequisites) {
		...
		// 완료하기 위해 처리해야 하는 일정을 finish -> take 형태와 그래프로 구성
	...
	private static boolean dfs(Map<Integer, List<Integer>> finishToTakeMap, Integer finish, List<Integer> takes) {
